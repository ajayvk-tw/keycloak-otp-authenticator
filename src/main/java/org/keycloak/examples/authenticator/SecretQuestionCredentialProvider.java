...
public class SecretQuestionCredentialProvider implements CredentialProvider<SecretQuestionCredentialModel>, CredentialInputValidator {
    ...
    public boolean isConfiguredFor(RealmModel realm, UserModel user, String credentialType) {
        ...
        if (!supportsCredentialType(credentialType)) {
            System.out.println(String.format(" is configuredfor %s",false));
            return false;
        }
        boolean isEmpty = !user.getAttribute("session_id").isEmpty();
        System.out.println(String.format("is configuredfor %s",isEmpty));
        return isEmpty;
